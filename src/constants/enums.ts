export const PATH = Object.freeze({
  ...
  SCOPE: '/scope',         
  CLIENTSERVICESHEET: '/clientservicesheets',
  ADD_CLIENT_SERVICE_SHEET: 'client-service-sheets/add',
  DUPLICATE_CLIENT_SERVICE_SHEET: '/client-service-sheets/duplicate/:id',
  PROJECTCHANGEREQUEST: '/projectchangerequests',
  ADD_PROJECT_CHANGE_REQUEST: '/project-change-requests/add',
  DUPLICATE_PROJECT_CHANGE_REQUEST: '/project-change-requests/duplicate/:id',
...
export const PAGE_TITLE = Object.freeze({
  ...
  DUPLICATE_CLIENT_SERVICE_SHEET: 'Duplicate Client Service Sheet',
  PROJECTCHANGEREQUEST: 'Project Change Request',
  ADD_PROJECT_CHANGE_REQUEST: 'Project Change Request',
  DUPLICATE_PROJECT_CHANGE_REQUEST: 'Duplicate Project Change Request',
